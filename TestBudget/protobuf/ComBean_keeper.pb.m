...
static PBTransaction* defaultTransactionInstance = nil;
+ (void) initialize {
    if (self == [PBTransaction class]) {
        defaultTransactionInstance = [[PBTransaction alloc] init];
    }
}
...
+ (PBTransaction*) parseFromData:(NSData*) data {
    return (PBTransaction*)[[[PBTransaction builder] mergeFromData:data] build];
}
+ (PBTransaction*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
    return (PBTransaction*)[[[PBTransaction builder] mergeFromData:data extensionRegistry:extensionRegistry] build];
}
+ (PBTransaction*) parseFromInputStream:(NSInputStream*) input {
    return (PBTransaction*)[[[PBTransaction builder] mergeFromInputStream:input] build];
}
+ (PBTransaction*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
    return (PBTransaction*)[[[PBTransaction builder] mergeFromInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (PBTransaction*) parseFromCodedInputStream:(PBCodedInputStream*) input {
    return (PBTransaction*)[[[PBTransaction builder] mergeFromCodedInputStream:input] build];
}
+ (PBTransaction*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
    return (PBTransaction*)[[[PBTransaction builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry] build];
}
+ (TransactionBuilder*) builder {
    return [[TransactionBuilder alloc] init];
}
+ (TransactionBuilder*) builderWithPrototype:(PBTransaction*) prototype {
    return [[PBTransaction builder] mergeFrom:prototype];
}
- (TransactionBuilder*) builder {
    return [PBTransaction builder];
}
- (TransactionBuilder*) toBuilder {
    return [PBTransaction builderWithPrototype:self];
}
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
    ...
    if ([self.unknownFields respondsToSelector:@selector(storeInDictionary:)]) {
        [self.unknownFields performSelector:@selector(storeInDictionary:) withObject:dictionary];
    }
}
- (BOOL) isEqual:(id)other {
    ...
    if (![other isKindOfClass:[PBTransaction class]]) {
        return NO;
    }
    PBTransaction *otherMessage = other;
    return
...
@property (strong) PBTransaction* resultTransaction;
@end
...
- (instancetype) init {
    if ((self = [super init])) {
        self.resultTransaction = [[PBTransaction alloc] init];
    }
    return self;
}
...
- (TransactionBuilder*) clone {
    return [PBTransaction builderWithPrototype:resultTransaction];
}
- (PBTransaction*) defaultInstance {
    return [PBTransaction defaultInstance];
}
- (PBTransaction*) build {
...
- (PBTransaction*) buildPartial {
    PBTransaction* returnMe = resultTransaction;
    self.resultTransaction = nil;
    return returnMe;
}
- (TransactionBuilder*) mergeFrom:(PBTransaction*) other {
    if (other == [PBTransaction defaultInstance]) {
        return self;
    }
    if (other.hasGuid) {
...
- (void) writeToCodedOutputStream:(PBCodedOutputStream*) output {
    [self.addedOrModifiedArray enumerateObjectsUsingBlock:^(PBTransaction *element, NSUInteger idx, BOOL *stop) {
...
- (void) storeInDictionary:(NSMutableDictionary *)dictionary {
    for (PBTransaction* element in self.addedOrModifiedArray) {
...
- (AccountDeltaBuilder*) mergeFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {
    ...
    while (YES) {
        ...
        switch (tag) {
            ...
            case 10: {
                TransactionBuilder* subBuilder = [PBTransaction builder];
